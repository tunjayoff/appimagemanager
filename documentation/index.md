...
*   It can **install** them like a normal program. This means it carefully takes the contents out of the AppImage backpack and puts them in the right places on your computer, creating menu shortcuts and icons so they feel like any other app.
...
*   **[Installation Guide](./installation.md):**
    ...
    *   Shows the different ways you can install it.
*   **[Usage Guide](./usage.md):**
    ...
    *   Explains how to manage the apps you've added (running them, removing them).
    *   Describes how to find and delete any leftover files after uninstalling an app.
